...
from cuda_optimization_with_module import (
    SpladeTextEncoderV2Cuda, 
    HFMaskedLanguageModelHiddenStatesEnabled, 
    CudaMaxAggregation)
...
##########################################################################################
    ...
    if cfg.splade.model == "splade_max":
        splade_encoder = SpladeTextEncoderV2Cuda.C(
            ...
            encoder=HFMaskedLanguageModelHiddenStatesEnabled.from_pretrained_id(cfg.base_hf_id),
